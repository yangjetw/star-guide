...
<body>
  ...
  <footer class="site-footer"><p>© 赫爾墨斯的小宇宙。出生資料只用於專屬指南製作。</p><a class="payment-report-link" href="[私人付款回報表單]" target="_blank" rel="noopener noreferrer">付款完成回報</a></footer>
